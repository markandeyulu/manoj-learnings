...
// Will it take the context that created during the DispatchServletInitializer - Yes. Automatically.
//Back Controller
...
/*	@GetMapping("/product")
	...
	//Hibernate learning page - docs.jboss.org/hibernate/orm/5.0/userguide/html_single/Hibernate_User_Guide
	@GetMapping("/product")
	@ResponseBody
	public List<Product> getProductDetails() {
	...
	//@RequestBody - to read request envelope which will have request header // it will accept xml and json 
	...
	*/ //This can be handled with the controller advice as well.
	// Here you can handle userspecific exception classes too. But ModelView is not possible here but thats possible in controller advice. Check this by changinbgf the return type
